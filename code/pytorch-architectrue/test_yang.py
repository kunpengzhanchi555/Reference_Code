...
batch_size = 64
arch = "resnet50"
ckp_path = "/root/hdd/yankun/Kaggle/quick_draw/pytorch-architectrue/checkpoint/checkpoint1127_best.pth2.tar"
...
def main():
    ...
    for trans in TTA10_preprocess:
        ...
        test_loader = DataLoader(
            test_dataset, batch_size, shuffle=False, pin_memory=False)
        print("test loading....")
        model = models.__dict__[arch]()
        model = FineTuneModel(model, arch, 340)
        # model.cuda()
